        ...
        with gr.Tabs() as fun_tabs:
            ...
            with gr.TabItem("Image", id=2):
                ...
                with gr.Row(visible=True) as row_image_prompt:
                    image_prompt = gr.Textbox(placeholder=f'80s sports car cruising down a scenic coastal highway at sunset shot on Kodak Ektar 100', value=f'80s sports car cruising down a scenic coastal highway at sunset shot on Kodak Ektar 100', label="Prompt", show_label=True, visible=True, lines=2)
            ...
            with gr.TabItem("Interface", id=5):
